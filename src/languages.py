localisation_ru = {
    ...
    'GOODBYE': 'До свидания!',
    'FEEDBACKMESSAGE': 'Здесь можно оставить замечание или пожелание для разработчиков бота:',
    ...
    'NOMARKED': 'Нет отмеченных докладов',
